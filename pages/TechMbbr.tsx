...
const TechMbbr: React.FC<{ addLead: (l: any) => void }> = ({ addLead }) => {
  ...
  const images = [
    "/images/MBBR/MBBR Images 4.png",
    "/images/MBBR/MBBR Images 2.png",
    "/images/MBBR/MBBR Images 3.png",
    "/images/MBBR/MBBR Images 5.png",
    "/images/MBBR/MBBR Images 6.png",
  ];
    ...
    <div className="bg-white">
        ...
        <div className="bg-[#020617] py-24 text-white relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="max-w-4xl">
              <h1 className="text-5xl md:text-5xl font-bold mb-6 heading-font">Moving Bed Bio Reactor (MBBR)</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2">
              <div className="rounded-[2.5rem] overflow-hidden shadow-2xl mb-16 border-8 border-slate-50">
                <img src="/images/MBBR/MBBR-Moving Bed Bioreactor System.png" alt="MBBR Carriers" className="w-full h-[450px] object-cover" />
              </div>
              ...
              <div className="prose prose-lg text-slate-600 max-w-none">
                ...
                <p className="mb-6 text-justify">
                  <span className="font-semibold text-slate-900">M-Flocs technology</span> employs thousands of polyethylene bio ﬁlm carriers operating in mixed motion within an aerated wastewater treatment basin. Each individual bio carrier increases productivity through providing protected surface area to support the growth of heterotrophic and autotrophic bacteria within its cells. It is this high-density population of bacteria that achieves high-rate biode gradation within the system, while also offering process reliability and ease of operation. This technology provides cost-effective treatment with minimal maintenance since MBBR processes self-maintain an optimum level of productive bio ﬁlm. Additionally, the bio ﬁlm attached to the mobile bio carriers within the system automatically responds to load ﬂuctuations.
                </p>
              </div>
            </div>
            {/* Sidebar Section */}
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className='py-6'>
            <img
              src="/images/MBBR/MBBR+UF_PFD-Model_pages-to-jpg-0001.png"
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <p className="text-slate-600 text-md">Compact units with small size.</p>
                </div>
                <div className="flex items-start">
                  <SquareCheckBig className='w-7 h-7 text-blue-600 mr-3' />
                  <p className="text-slate-600 text-md">Increased treatment capacity.</p>
                </div>
                <div className="flex items-start">
                  <SquareCheckBig className='w-7 h-7 text-blue-600 mr-3' />
                  <p className="text-slate-600 text-md">Complete solids removal.</p>
                </div>
                <div className="flex items-start">
                  <SquareCheckBig className='w-7 h-7 text-blue-600 mr-3' />
                  <p className="text-slate-600 text-md">Improved settling characteristics.</p>
                </div>
                <div className="flex items-start">
                  <SquareCheckBig className='w-7 h-7 text-blue-600 mr-3' />
                  <p className="text-slate-600 text-md">Operation at higher suspended biomass.</p>
                </div>
                <div className="flex items-start">
                  <SquareCheckBig className='w-7 h-7 text-blue-600 mr-3' />
                  <p className="text-slate-600 text-md">Concentrations leading to long sludge retention times.</p>
                </div>
                <div className="flex items-start">
                  <SquareCheckBig className='w-7 h-7 text-blue-600 mr-3' />
                  <p className="text-slate-600 text-md">Enhanced process stability.</p>
                </div>
                <div className="flex items-start">
                  <SquareCheckBig className='w-7 h-7 text-blue-600 mr-3' />
                  <p className="text-slate-600 text-md">Low head loss.</p>
                </div>
                <div className="flex items-start">
                  <SquareCheckBig className='w-7 h-7 text-blue-600 mr-3' />
                  <p className="text-slate-600 text-md">No ﬁlter channelling.</p>
                </div>
                <div className="flex items-start">
                  <SquareCheckBig className='w-7 h-7 text-blue-600 mr-3' />
                  <p className="text-slate-600 text-md">No need of periodic back washing.</p>
                </div>
                <div className="flex items-start">
                  <SquareCheckBig className='w-7 h-7 text-blue-600 mr-3' />
                  <p className="text-slate-600 text-md">Reduced sludge production and no problems with Sludge bulking.</p>
                </div>
                <div className="flex items-start">
                  <SquareCheckBig className='w-7 h-7 text-blue-600 mr-3' />
                  <p className="text-slate-600 text-md">Life of carrier media up to 10 years.</p>
                </div>
              </div>
            </div>
            <div className="order-1 lg:order-2 bg-slate-900 rounded-[3rem] p-3 flex items-center justify-center shadow-2xl">
              <img
                src="/images/MBBR/MBBR Images 1.png"
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: "Sewage Treatment", text: "Delivers high-efficiency removal of organic load, suspended solids, and pathogens." },
  { title: "Effluent Treatment", text: "Treats complex industrial wastewater with consistent performance and compliance." },
  { title: "Food Industries", text: "Removes fats, proteins, and organic contaminants from high-strength processing wastewater." },
  { title: "Nominal Parameter Industries", text: "Optimizes treatment of low to medium strength effluent with stable process control." }
